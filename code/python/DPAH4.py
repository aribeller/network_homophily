...
def DPAH4(N, fm, fa, d, plo_M, plo_m, h_MM, h_mm, acceptance = "maj",  verbose=False, seed=None):
    '''
    ...
    - h_MM: homophily among majorities
    - h_mm: homophily among minorities
    - acceptance: denotes which groups are accpting of allies/covert, "maj" for majority only, "maj/al" for majority
    and allies/covert, "all" for majorities, allies/covert, and minorities all being accepting
